...
const Body = () => {
  return (
    <div className='min-h-screen flex flex-col items-center justify-center'>
        ...
        <h1 className='text-[#ffffff] text-6xl mt-3 font-semibold'>
            Thank You!
        </h1>
        <p className='text-[#a6a9b1] mt-1.5 text-lg'>
            Your purchase was successful.
        </p>
        <p className='text-[#a6a9b1] -mt-1 text-lg'>
      ...
      <div className="relative w-63 bg-linear-to-br from-[#1a1a1c] to-[#111112] rounded-l-md rounded-r-xl shadow-[20px_20px_50px_rgba(0,0,0,0.8),inset_1px_1px_2px_rgba(255,255,255,0.05)] pt-6 px-6 mt-5 overflow-hidden">
        ...
        <div className="ml-2.5 flex flex-col">
          ...
          <h2 className="text-white text-3xl font-semibold tracking-[0.02em] mb-1.5 [text-shadow:0px_4px_10px_rgba(0,0,0,0.5)]">
            MAKE YOUR
          </h2>
          
          <h1 className="text-[#d1a44e] text-[3rem] font-bold leading-[1.05]   [text-shadow:0px_10px_20px_rgba(0,0,0,0.6),0px_2px_4px_rgba(0,0,0,0.3)] mb-3">
            FIRST<br />
            $100.
          </h1>
          
          <p className="text-[#d1d1d1] text-[0.89rem] leading-[1.6] font-normal mb-7">
