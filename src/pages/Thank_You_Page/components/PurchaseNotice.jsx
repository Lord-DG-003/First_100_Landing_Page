...
const PurchaseNotice = () => {
    ...
    const LinksText=["contact support.","Terms of Use."];
    const Links=["mailto:hustlemote@gmail.com","https://www.notion.so/Terms-Conditions-3b41d86144e6809f92cbd3e8eceb7146?source=copy_link"]
            ...
            <div className='border border-[#1f232a] flex items-center h-fit w-92 md:w-120 mt-5 py-4 px-0 rounded-md'>
               ...
               <div className='border-l border-[#1f232a]'>
                    ...
                    <p className='text-[#a6a9b1] ml-4 text-[14px] md:pr-6'>
                        {Descriptions[index]} <a href={Links[index]} className='text-[#d4af37] cursor-pointer hover:text-[#f5be08]'>{LinksText[index]}</a>
                    </p>
               </div>
            </div>
        ))}
