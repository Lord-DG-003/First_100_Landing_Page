...
const Navbar = () => {
  ...
  return (
    <nav className='text-[#ffffff] flex justify-between items-center pt-4 px-4 sm:px-6 md:px-10 font-semibold'>
        ...
        <div className='flex items-center text-[#a6a9b1]'>
            <VscLockSmall size={24} className='mr-2 '/>Secure Checkout
        </div>

        <button className='flex items-center text-[#c6c6c6] cursor-pointer hover:text-amber-50 active:scale-97' onClick={handleClick}>
