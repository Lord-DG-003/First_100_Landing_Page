...
const UnitsLeft = () => {
  return (
    <div className='text-white flex flex-col md:flex-row w-140 items-center justify-center border border-[#1f232a] rounded-xl bg-[#131313] '>
        ...
        <div className='flex flex-col md-pt-0  md:pl-4 items-center justify-center w-5/8 md:border-l md:border-[#1f232a] md:my-5 my-1.5'>
            ...
            <p className='text-5xl pt-3 md:pt-1'>1,842</p>
