...
const Features = () => {
  ...
  return (
    <div className='flex flex-wrap justify-center md:w-full md:border-0 w-90 rounded-xl max-w-237.5 mx-auto gap-4 md:gap-5 mt-10 px-4 border border-[#1f232a] bg-[#131313] md:bg-[#0a0a0a]'>
