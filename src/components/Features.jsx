        ...
        {Logos.map((Logo,index)=>(
          <div key={index} className='flex md:flex-col md:items-center md:text-center md:border md:border-[#1f232a] w-full sm:w-[calc(50%-0.75rem)] md:w-[calc(25%-1rem)] md:pt-8 px-1 md:pb-8 rounded-xl py-2.5 md:bg-[#131313]'>
            ...
            <div className='flex flex-col md:px-0 px-10'>
              <h3 className='text-[#ffffff] font-semibold text-base md:text-[21px] md:mb-2 font-satoshi'>
                {Titles[index]}
              </h3>
              <p className='text-[#a6a9b1] md:px-2 md:text-[15px] leading-relaxed font-inter'>
                {Descriptions[index]}
              </p>
            </div>
          </div>
