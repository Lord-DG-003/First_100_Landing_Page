...
const Notice = () => {
  return (
    <div className="flex justify-center px-4 py-8 md:py-16 w-full font-inter">
      <div className="relative border border-[#d4af37]/40 rounded-xl px-6 md:px-12 py-4 md:py-7.5 w-full max-w-212.5 text-center mt-4 md:mt-1]">
        ...
        <p className="text-[#a6a9b1] md:p-0 px-16 text-[16px] md:text-lg">
