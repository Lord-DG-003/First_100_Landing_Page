...
const Subscription = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center px-4 w-full'>
        ...
        <button className='bg-[#d4af37] cursor-pointer active:scale-95 transform transition-all text-[#0a0a0a] flex rounded-lg w-full max-w-105 justify-center py-3.5 md:py-4 mt-6 md:mt-8 items-center hover:bg-[#c39b2b]' onClick={handleClick}>
