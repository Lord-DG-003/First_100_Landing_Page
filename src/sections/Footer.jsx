...
const Footer = () => {
  return (
    <footer className='flex flex-col md:flex-row justify-between items-center w-full px-4 md:px-10 py-8 md:py-4 border-t border-[#1f232a] bg-[#0a0a0a] text-white gap-6 md:gap-0 font-inter'>
