...
const Footer = () => {
  return (
    <footer className='flex flex-col md:flex-row justify-between items-center w-full px-4 md:px-10 py-5 md:py-4 border-t border-[#1f232a] bg-black text-white gap-2.5 md:gap-0 font-inter'>
